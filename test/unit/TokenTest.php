...
use DateInterval;
use DateTime;
use Matheust45\JWT\Claim\Basic;
use Matheust45\JWT\Claim\EqualsTo;
use Matheust45\JWT\Claim\GreaterOrEqualsTo;
use Matheust45\JWT\Claim\LesserOrEqualsTo;
...
class TokenTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @test
     *
     * @covers Matheust45\JWT\Token::__construct
     */
     ...
     *
     * @covers Matheust45\JWT\Token::hasHeader
     */
     ...
     *
     * @uses Matheust45\JWT\Token::__construct
     * @uses Matheust45\JWT\Token::hasHeader
     *
     * @covers Matheust45\JWT\Token::getHeader
     *
     ...
     *
     * @covers Matheust45\JWT\Token::getHeader
     * @covers Matheust45\JWT\Token::getHeaderValue
     */
     ...
     * @uses Matheust45\JWT\Token::__construct
     * @uses Matheust45\JWT\Token::hasHeader
     * @uses Matheust45\JWT\Claim\Basic
     *
     * @covers Matheust45\JWT\Token::getHeader
     * @covers Matheust45\JWT\Token::getHeaderValue
     */
     ...
     * @uses Matheust45\JWT\Token::__construct
     *
     * @covers Matheust45\JWT\Token::getHeaders
     */
     ...
     * @uses Matheust45\JWT\Token::__construct
     *
     * @covers Matheust45\JWT\Token::getClaims
     */
     ...
     * @uses Matheust45\JWT\Claim\Basic
     *
     * @covers Matheust45\JWT\Token::hasClaim
     */
     ...
     *
     * @uses Matheust45\JWT\Token::__construct
     * @uses Matheust45\JWT\Token::hasClaim
     * @uses Matheust45\JWT\Claim\Basic
     *
     * @covers Matheust45\JWT\Token::getClaim
     */
     ...
     * @uses Matheust45\JWT\Token::__construct
     *
     * @covers Matheust45\JWT\Token::verify
     *
     ...
     *
     * @covers Matheust45\JWT\Token::verify
     * @covers Matheust45\JWT\Token::getPayload
     */
     ...
     *
     * @covers Matheust45\JWT\Token::validate
     * @covers Matheust45\JWT\Token::getValidatableClaims
     */
     ...
     *
     * @uses Matheust45\JWT\Token::__construct
     * @uses Matheust45\JWT\ValidationData
     * @uses Matheust45\JWT\Claim\Basic
     * @uses Matheust45\JWT\Claim\EqualsTo
     *
     * @covers Matheust45\JWT\Token::validate
     * @covers Matheust45\JWT\Token::getValidatableClaims
     */
     ...
     * @uses Matheust45\JWT\Claim\Basic
     * @uses Matheust45\JWT\Claim\EqualsTo
     * @uses Matheust45\JWT\Claim\LesserOrEqualsTo
     * @uses Matheust45\JWT\Claim\GreaterOrEqualsTo
     *
     * @covers Matheust45\JWT\Token::validate
     * @covers Matheust45\JWT\Token::getValidatableClaims
     */
     ...
     * @test
     *
     * @covers Matheust45\JWT\Token::isExpired
     *
     * @uses Matheust45\JWT\Token::__construct
     * @uses Matheust45\JWT\Token::getClaim
     * @uses Matheust45\JWT\Token::hasClaim
     */
     ...
     *
     * @uses Matheust45\JWT\Token::__construct
     * @uses Matheust45\JWT\Token::getPayload
     *
     * @covers Matheust45\JWT\Token::__toString
     */
